#pragma once
/**
 * Хук устройства Direct3D 9 (прокси fIDirect3DDevice9).
 *
 * ИМЯ ФАЙЛА ВАЖНО. Раньше он назывался d3d9.h и затенял системный <d3d9.h>:
 * в конфигурации Debug каталог проекта стоял в путях поиска ПЕРВЫМ, поэтому
 * строка ниже включала сама себя, #pragma once гасил повтор, и ни один тип
 * DirectX не объявлялся — конфигурация Debug не собиралась в принципе.
