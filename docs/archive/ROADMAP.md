...
> **ARCHIVED.** Не контракт. Живое: `docs/SOURCE_OF_TRUTH.md`.

> **DEPRECATED как актуальный план (аудит 84.21).** Канон состояния и пробелов:
> [`SOURCE_OF_TRUTH.md`](SOURCE_OF_TRUTH.md) §13. Ниже — снимок 2026-08-18.
