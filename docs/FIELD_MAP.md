...
| волки / скелеты / нежить / гарпии / призраки / голем | в `tree[]` | create не разобран | — |
| `uEm8000` / фауна | **нет в tree** (кап) | live `[0]=0x015BB278` | ✅ 6 тел, имя каталога врать |
...
### HUNT 30 — hot ring + merge (ждём dump24)

Полл только `0x10000000–0x18000000` (все тушки dump18–23). Пусто: 8 МБ/тик ≈ 2.4 с на круг. Есть список: 4 МБ/тик, новый сид **сливается**, не выключает обход. Не ждать Hunt.
