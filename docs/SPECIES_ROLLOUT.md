...
> **§9 DEPRECATED (аудит 84.21).** `uEm0100` больше не `tempoRage=false` / pin-only:
> карточка даёт std-rush `1.21..1.24 / 1.32..1.40`. Канон: [`SOURCE_OF_TRUTH.md`](SOURCE_OF_TRUTH.md) §8.
> Допуск вида (§2) и ActMap (§3) по-прежнему верны как метод.
